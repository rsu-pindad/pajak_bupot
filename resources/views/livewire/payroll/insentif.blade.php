...
<div class="mb-4 grid grid-cols-1 gap-4 sm:grid-cols-1 lg:grid-cols-1">
  <div class="h-auto overflow-x-auto rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 md:h-auto">
    <div class="p-6">
      ...
      <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label for="bulan_periode_insentif" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bulan Periode Insentif</label>
        ...
        <div>
          <label for="bulan_pembayaran_insentif" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bulan Pembayaran Insentif</label>
        ...
        <div>
          <label for="tahun_insentif" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukan Tahun Insentif</label>
  ...
  <div class="h-64 overflow-x-hidden rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 md:h-auto">
    <div class="p-6">
      <livewire:power.payroll.insentif-tabel lazy wire:key="{{ uniqid() }}"/>
    </div>
  </div>
</div>
