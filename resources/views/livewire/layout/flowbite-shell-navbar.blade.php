  ...
  <div class="flex flex-wrap items-center justify-between">
    <div class="flex items-center justify-start">
      ...
      <a href="https://flowbite.com"
        ...
        <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">Pajak</span>
      </a>
    </div>
    <div class="flex items-center lg:order-2">
      ...
      <button id="user-menu-button"
        ...
        {!! Avatar::create(Auth::user()->email)->setDimension(36)->setFontSize(18)->toSvg() !!}
      </button>
      <!-- Dropdown menu -->
      <div id="dropdown"
        ...
        <ul class="py-1 text-gray-700 dark:text-gray-300"
          ...
          <li>
            <a href="#"
               class="block px-4 py-2 text-sm hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">My
              profile</a>
          </li>
          <li>
            <a href="#"
               class="block px-4 py-2 text-sm hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">Account
              settings</a>
          </li>
        </ul>
        <ul class="py-1 text-gray-700 dark:text-gray-300"
          ...
          <li>
            <a wire:click="logout"
               href="#"
               class="block px-4 py-2 text-sm hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Sign
              out</a>
          </li>
        </ul>
      </div>
