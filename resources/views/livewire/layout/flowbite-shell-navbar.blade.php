  ...
  <div class="flex flex-wrap items-center justify-between">
    ...
    <div class="flex items-center lg:order-2">
      ...
      <div id="dropdown"
        ...
        <div class="px-4 py-3">
          <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ Auth::user()->npp }}</span>
        ...
        <ul class="py-1 text-gray-700 dark:text-gray-300"
          ...
          <li>
            <a href="{{ route('profile') }}"
               wire:navigate="false"
               class="block px-4 py-2 text-sm hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
              Profil</a>
          </li>
        </ul>
        <ul class="py-1 text-gray-700 dark:text-gray-300"
          ...
          <li>
            <a wire:click="logout"
               href="#"
               class="block px-4 py-2 text-sm hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">
              Keluar
            </a>
          </li>
        </ul>
