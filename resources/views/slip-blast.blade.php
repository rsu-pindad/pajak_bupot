...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <title>Slip Insentif & Kehadiran</title>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="py-2"
                    colspan="2"
                    class="text-right">
                  <p class="text-right">{{ number_format($insentif->nominal_max_insentif_kinerja, 2, ',', '.') }}</p>
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table-fixed uppercase">
            ...
            <tbody>
              <tr>
                ...
                <td class="py-2"
                    colspan="2">
                  <p class="text-right">{{ $insentif->kinerja_keuangan_perusahaan * 100 }}%</p>
                </td>
              </tr>
              <tr>
                ...
                <td class="py-2"
                    colspan="2">
                  <p class="text-right">{{ $insentif->nilai_kpi * 100 }}%</p>
                </td>
              </tr>
              <tr>
                ...
                <td class="py-2"
                    colspan="2">
                  <p class="text-right">{{ number_format($insentif->insentif_kinerja, 2, ',', '.') }}</p>
                </td>
              </tr>
              <tr>
                ...
                <td class="py-2"
                    colspan="2">
                  <p class="text-right">{{ number_format($insentif->pembulatan, 2, ',', '.') }}</p>
                </td>
              </tr>
              <tr class="font-bold">
                ...
                <td class="py-2"
                    colspan="2">
                  <p class="text-right">{{ number_format($insentif->diterimakan, 2, ',', '.') }}</p>
                </td>
              </tr>
            </tbody>
          </table>
